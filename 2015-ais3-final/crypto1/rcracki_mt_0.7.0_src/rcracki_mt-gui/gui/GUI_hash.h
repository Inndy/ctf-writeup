...
bool HashAlreadyInList(const char*);
int AddHash(const char*);
void LoadHashes(GtkWidget*);
void HideHashWindow(GtkWidget*);
void ShowHashWindow(GtkWidget*);
void SetupHashWindow();
void UpdateHashIters(int);
