...
uint32_t RTCPReader::getChainsLeft()
{
...
int RTCPReader::readChains(uint32_t &numChains, RainbowChainCP *pData)
{
...
void RTCPReader::setChainSizeBytes( uint32_t chainSizeBytes )
{
